 ...
 * deposit on account by service and send it in JSON format.
 */
@RequiredArgsConstructor
public class RestDepositCommand implements RestCommand {
    ...
    /**
     * Method deposit on account by AccountService, update and set in attribute account and status, map to JSON.
     *
    ...
    public String execute(HttpServletRequest req) {
        ...
        AccountDto updated = accountService.deposit(id, value);
